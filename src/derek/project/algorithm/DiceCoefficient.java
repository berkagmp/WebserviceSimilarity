...
public class DiceCoefficient {
	 ...
	 * 
	 * <p>
	 * Note that, at the time of writing, this implementation differs from the other
	 * implementations on this page. Where the other algorithms incorrectly store
	 * the generated bigrams in a set (discarding duplicates), this implementation
	 * actually treats multiple occurrences of a bigram as unique. The correctness
	 * of this behavior is most easily seen when getting the similarity between "GG"
	 * and "GGGGGGGG", which should obviously not be 1.
	 * 
	 * @param s
	 *            The first string
	 * @param t
	 ...
	 *         or both of the strings are {@code null}. Also returns 0 if one or
